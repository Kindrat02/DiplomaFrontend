...
import { getUserBooking, modifyBooking } from "../../../api/BookingApi";
...
class BookingDetailsPage extends Component {
    ...
    getBookingDetails() {
        ...
        getUserBooking(this.props.match.params.id)
            .then(res => {
                this.setState({
                    booking: res.data.booking
                });
                getCar(this.state.booking.car)
                    .then(res => {
                        this.setState({
                            car: res.data.car
                        })
                    });
                getLocationFromId(this.state.booking.location)
                    .then(res => {
    ...
    handleCancelButton() {
        ...
        modifyBooking(this.state.booking)
            .then(() => {
                this.getBookingDetails()
            }).catch((error) => {
                this.setState({ errorMessage: error.response.data.message });
