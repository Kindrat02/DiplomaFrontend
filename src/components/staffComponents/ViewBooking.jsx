...
import { getBooking, modifyBooking } from "../../api/BookingApi";
import { Map, InfoWindow, Marker, GoogleApiWrapper } from "google-maps-react";
import { getAddressFromGeocode, getLocationFromId } from "../../api/LocationApi";
...
class ViewBookingPage extends Component {
    ...
    getBookingDetails() {
        ...
        getBooking(this.props.match.params.id)
            .then(res => {
                this.setState({
