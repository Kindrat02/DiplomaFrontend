...
import { updateCar, getCar } from "../../api/CarApi";
import { getLocationFromId, getAllLocations } from "../../api/LocationApi";
import { CAR_COLOURS, CAR_BODY_TYPES, CAR_FUEL_TYPES, CAR_SEATS, FILE_UPLOAD_LIMIT } from "../../Constants";
...
export default class ModifyCarDetails extends Component {
    ...
    getCar() {
        getCar(this.props.match.params.id).then(res => {
            const car = res.data.car;
            getLocationFromId(car.location).then(res => {
